...
function defaultValues()
    ...
    SetInt('savegame.mod.airstrikeMaxMissiles', 100)
    SetFloat('savegame.mod.airstrikeDelay', 0.1)
end
if not (GetBool('savegame.mod.airstrikeDefaultSetupv2')) then
    defaultValues()
    SetBool('savegame.mod.airstrikeDefaultSetupv2', true)
end
...
function drawDebugMenu(ingame, active)
    --UiEnableInput()
    ...
    UiPush()
        ...
        drawSlider("Max missiles", 'savegame.mod.airstrikeMaxMissiles', "x", 1, 600, 100)
